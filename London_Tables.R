...
playerlb$Player <- replace(as.character(playerlb$Player), playerlb$Player == "Alex", "Alexx")


write.csv(playerlb, file = "TestPlayerLeaderboardLondon.csv")
write.csv(teamlb, file = "TestTeamLeaderboardLondon.csv")
